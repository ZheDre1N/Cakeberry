...
extension Product {
    static func testData() -> [Product] {
        let product1 = Product(title: "Рубленные котлетки", price: "550", imageName: "p1", description: "Шикарные котлетки от лучшего шеф-пофара поволжья")
        let product2 = Product(title: "Красный бархат", price: "2200", imageName: "p2", description: "Нежнейший тортик с натуральными ингридиентами")
